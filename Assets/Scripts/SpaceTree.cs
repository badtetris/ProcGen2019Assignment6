...
public class TreeNode {
    ...
    public bool doRandomSplit() {
        ...
        // Replace this code with code that will produce a randomly shaped tree!
        // This existing code does NOT produce a randomly shaped tree.
        if (isLeaf) {
            return tryToSplit();
        }
        else if (leftChild.canSplit()) {
